...
// src/services/personalLoanService.ts) on mount, falling back to this page's
...
export function PersonalLoanPage() {
  ...
  const title = data?.title ?? 'Personal Loan';
  const description = data?.description ?? 'Get fixed repayments on flexible terms';
