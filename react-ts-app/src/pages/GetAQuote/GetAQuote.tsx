...
const QUOTE_CARDS: QuoteCard[] = [
  ...
  },
  {
    ...
    description: 'Open an account that grows with you. Enjoy lower banking fees, and instant transfers.',
  ...
  },
  {
    id: 'funeral',
    title: 'Funeral Cover',
    description: 'Protect your loved ones with dignity. Get a reliable funeral cover that backs you.',
    href: '/en/home/product-funeral-cover/#funeral-calculator',
  },
  {
    id: 'isiko',
    title: 'Isiko',
    description: 'Build a future that reflects who you are. An account designed for community.',
...
export function GetAQuote() {
  ...
  return (
    <>
      <section id="step1" className="step active mtb-30" aria-labelledby="bank-with-audacity">
        <div className="container">
          ...
          <div className="row">
            {QUOTE_CARDS.map((card) => (
              <div className="col-xs-12 col-sm-4 col-md-4 mb-30" role="listitem" key={card.id}>
            ...
            <div className="col-xs-12 col-sm-4 col-md-4 mb-30" role="listitem" />
          </div>
        </div>
      </section>
