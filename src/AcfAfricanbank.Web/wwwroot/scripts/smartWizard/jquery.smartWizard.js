...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnCancel = this.options.toolbarSettings.showPreviousButton !== false ? $('<a></a>').text("Cancel").addClass('sw-btn-cancel').attr('type', 'link') : null;
            ...
            // var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<a></a>').text(this.options.lang.previous).addClass('sw-can-prev').attr('type', 'link').css("display", "none") : null;
            var btnAcceptOffer = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text("Accept Offer").addClass('index_accept btn button primary').attr('type', 'button').css("display", "none").attr("id", "index_acceptId") : null;
            var btnGroup = $('<div></div>').addClass('btn-toolbar mr-2 sw-btn-group').attr('role', 'group').append(btnAcceptOffer, btnNext, btnCancel);
            ...
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<a></a>').text(this.options.lang.previous).addClass('sw-can-prev').attr('type', 'link').css("display", "none").css("cursor","pointer") : null;
            $(".sw-btn-group").append(btnPrevious);
            return true;
        },
        _setEvents: function () {
            // Anchor click event
            ...
            //    e.preventDefault();
            //    mi.reset();  //._showPrevious();
            //});

            $('.index_accept', this.main).on("click", function (e) {
                e.preventDefault();
            });
        ...
        _setAnchor: function (idx) {
            ...
            this.steps.eq(this.current_index).find('span').removeClass("badge-done");

            if (this.options.anchorSettings.markDoneStep !== false && this.current_index !== null) {
                this.steps.eq(this.current_index).parent('li').addClass("done");
                this.steps.eq(this.current_index).find('span').addClass("badge-done");

                if (this.options.anchorSettings.removeDoneStepOnNavigateBack !== false) {
                    this.steps.eq(idx).parent('li').nextAll().removeClass("done");
                    this.steps.eq(idx).parent('li').find('span').nextAll().removeClass("badge-done");
                }
            }

            // Next step anchor > Remove other classes and add active class
            this.steps.eq(idx).parent('li').removeClass("done").addClass("active");
            this.steps.eq(idx).find('span').addClass("badge-done");
            return true;
        },
