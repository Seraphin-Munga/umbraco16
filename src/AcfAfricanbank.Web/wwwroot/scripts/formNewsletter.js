...
$(document).ready(function () {
    $(function (ab, $) {
         ...
         */
        if (!$('#userDetailsForm').length > 0) { return; }
        /**
         * Variables State
         */
        console.log("Load newsletter js");

        var $userDetailsForm = $('#userDetailsForm'),
            $userDetailsFormForm = $('#userDetailsForm').find("form"),
        ...
        console.log("$cancelFormButton init");
        ...
        function validateEmailInput() {
            if (validateEmail($userEmailInput.val())) {
                ...
                $userEmailInput.removeClass("hascorrect_input");
                $userEmailInput.addClass("haserror_input");
                $(".error_email").show();
            }
        }
